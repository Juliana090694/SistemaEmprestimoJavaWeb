...
public class EmprestimoDAO {
	...
	public static List<Emprestimo> listar(){
		...
		*/
		...
		try {
		   tx = session.beginTransaction();
		   Query q = session.createQuery("SELECT c FROM Emprestimo c");
	...
	public static void remover(Emprestimo emprestimo){
		Configuration cfg = new Configuration();
		cfg.configure("hibernate.cfg.xml"); 
	...
	public static Emprestimo buscar(int id){
		Configuration cfg = new Configuration();
		cfg.configure("hibernate.cfg.xml"); 
	...
	public static List<Emprestimo> retornarEmprestimo(){
		List<Emprestimo> lista = null;
